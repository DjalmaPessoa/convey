...
for ( this.g in seq(.25,.75, length.out = 3) )  {
  ...
  a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
  a2.nocov <- svyby( ~eqincome , ~hsize, des_eusilc , svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = FALSE )
  ...
  b2.nocov <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = FALSE )
  ...
  test_that("database svychu",{
    ...
    c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
    c2.nocov <- svyby( ~eqincome , ~hsize, dbd_eusilc , svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE )
  ...
  sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
  ...
  sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
  ...
  test_that("dbi subsets equal non-dbi subsets",{
    ...
    sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
    ...
    sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svychu , g = this.g , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
