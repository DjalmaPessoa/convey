...
# calculate estimates
a1 <- svyfgtdec( ~eqincome , des_eusilc , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
a2.nocov <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = FALSE )
b1 <- svyfgtdec( ~eqincome , des_eusilc_rep , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
b2.nocov <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = FALSE )
...
test_that("database svyfgtdec",{
  ...
  # calculate estimates
  c1 <- svyfgtdec( ~eqincome , dbd_eusilc , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
...
# calculate estimates
sub_des <- svyfgtdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
sub_rep <- svyfgtdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , covmat = TRUE )
  sub_dbr <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" , deff = TRUE , linearized = TRUE )
