...
# calculate estimates
a1 <- svylorenz( ~eqincome , des_eusilc , deff = TRUE , linearized = TRUE )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svylorenz , deff = TRUE , covmat = TRUE )
a2.nocov <- svyby( ~eqincome , ~rb090, des_eusilc , svylorenz , deff = TRUE , covmat = FALSE )
b1 <- svylorenz( ~eqincome , des_eusilc_rep , deff = TRUE , linearized = TRUE )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svylorenz , deff = TRUE , covmat = TRUE )
b2.nocov <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svylorenz , deff = TRUE , covmat = FALSE )
...
test_that("database svylorenz",{
  ...
  # calculate estimates
  c1 <- svylorenz( ~eqincome , dbd_eusilc , deff = TRUE , linearized = TRUE )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svylorenz , deff = TRUE , covmat = TRUE )
...
# calculate estimates
sub_des <- svylorenz( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , deff = TRUE , linearized = TRUE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svylorenz , deff = TRUE , covmat = TRUE )
sub_rep <- svylorenz( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , deff = TRUE , linearized = TRUE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svylorenz , deff = TRUE , covmat = TRUE )
...
test_that("subsets equal svyby",{
  ...
  cv_diff <- max( abs( cv( sub_des ) - cv( sub_rep ) ) , na.rm = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svylorenz( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , deff = TRUE , linearized = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svylorenz , deff = TRUE , covmat = TRUE )
  sub_dbr <- svylorenz( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , deff = TRUE , linearized = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svylorenz , deff = TRUE , covmat = TRUE )
